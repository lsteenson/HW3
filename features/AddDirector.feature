...
Scenario: add director to existing movie
  Given I have visited the Details about "Aliens" page
  When I have edited the movie "Aliens" to change the director to "Ridley Scott"
...
Scenario: can't find similar movies if we don't know director (sad path)
  ...
  And I am on the RottenPotatoes home page
  Then I should see "Aliens has no director"
